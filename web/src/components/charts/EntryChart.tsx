...
export default function EntryChart({ positions, hideLegend }: Props) {
  ...
  if (data.length === 0) return <p className="text-gray-500 text-center py-4">No data for entries chart</p>;

  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl p-4 border border-gray-200 dark:border-gray-800">
      <h3 className="text-lg font-semibold mb-4">Daily Positions Opened per Wallet</h3>
